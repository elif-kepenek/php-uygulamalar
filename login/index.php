...
<div  class="container d-flex align-items-center justify-content-center">
    <div class="card bg-light" style="width: 18rem;">
        ...
        <div class="card-body">
            ...
            <h6 class="card-subtitle mb-2 text-muted"><?= session('e-posta') ?></h6>
            ...
            <form action="islem.php?islem=hakkimda" method="post">
                <textarea class="form-control bg-light text-primary" name="hakkimda" id="" cols="30" rows="10"><?= htmlspecialchars_decode($hakkimda); ?></textarea>
